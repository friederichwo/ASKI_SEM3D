...
!-------------------------------------------------------------
 module fourierSpectrum
    ...
    interface operator (.vreel.); module procedure reelFourierSpectrum; end interface
...
!
    function reelFourierSpectrum(this) result(vreel)
    type (fourier_spectrum), intent(in) :: this
    real, dimension(:), pointer :: vreel
!
    allocate(vreel(this%nf))
    vreel = real(dreal(this%y))
    end function reelFourierSpectrum
!------------------------------------------------------------
