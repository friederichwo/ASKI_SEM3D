...
!> \param icall return call count
!
	function nextEventSeismicEventList(this,event,f,s,l,icall,reset) result(next)
	type (seismic_event_list), intent(in) :: this
	type (seismic_event) :: event
	integer, optional :: f,s,l,icall
...
!
	...
	if (present(icall)) icall = call_count
...
!
	function searchEventidSeismicEventList(this,eventid,event,iev) result(found)
	type (seismic_event_list) :: this
